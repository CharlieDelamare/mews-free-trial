...
function ApiCallRow({
  ...
  return (
    <div>
      ...
      {isExpanded && (
        <div className="text-gray-100 p-3 text-xs font-mono rounded mx-2 mb-1 overflow-hidden" style={{ backgroundColor: 'var(--mews-night-black)' }}>
          {detailLoading ? (
              ...
              {groups.length > 1 && (
                <div className="flex gap-1 mb-2 flex-wrap">
                  <button
                    ...
                    style={activeGroup === null ? { backgroundColor: 'var(--mews-charcoal)' } : undefined}
                  >
                    All ({total})
                  </button>
                  {groups
                    ...
                    .map(g => (
                      <button
                        ...
                        style={activeGroup === g.group ? { backgroundColor: 'var(--mews-charcoal)' } : undefined}
                      >
