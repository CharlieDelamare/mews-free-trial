...
export default function CloseBillsPage() {
  ...
  return (
    <>
      <main className="min-h-screen bg-mews-linen py-12 px-4">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-mews-night-black mb-2">Close Bills</h1>
            <p className="text-neutral-600">Close all open bills for a sandbox</p>
          </div>
      ...
      >
        <h2 id="close-bills-dialog-title" className="text-xl font-semibold text-mews-night-black mb-4">
          Confirm Close Bills
        </h2>
