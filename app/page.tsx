...
export default function FreeTrialPage() {
  const [activeTab, setActiveTab] = useState<'create' | 'reset' | 'demo-filler'>('create');
  ...
  useEffect(() => {
    if (activeTab === 'reset' || activeTab === 'demo-filler') {
      fetchEnvironments();
    }
  }, [activeTab]);
  ...
  const fetchEnvironments = async () => {
    ...
    try {
      ...
      if (data.success) {
        // Sort environments alphabetically by property name
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            {activeTab === 'create' && 'Request a free trial of Mews'}
            {activeTab === 'reset' && 'Reset an existing demo environment'}
            {activeTab === 'demo-filler' && 'Add reservations to an existing demo environment'}
          </p>
        </div>
