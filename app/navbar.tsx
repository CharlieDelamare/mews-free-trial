...
const onboardingLink = { href: '/onboarding', label: 'Onboarding' };
const allLinks = [...sandboxLinks, ...operationLinks, logsLink, onboardingLink];
        ...
        <nav className="flex-1 flex flex-col px-2 py-3 overflow-y-auto">
          ...
          <div className="mt-4">
            ...
            <div className="space-y-1">
              ...
              <Link key="/onboarding" href="/onboarding" onClick={close} className={linkClasses('/onboarding')}>
                <span className="flex items-center gap-2">
                  <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
